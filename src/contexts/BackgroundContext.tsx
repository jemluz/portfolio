...
import { getRandomColor } from "@/components/custom/background-page/ContentArea/colors.utils";
import { ColorKey } from "@/components/custom/background-page/ContentArea/content-item.types";
